...
const ND_PORTFOLIOS = {
  gd: { name:'Growth &amp; Development', role:'National Director', sections:[
    ...
    { type:'zoneTA', key:'foundation', title:'Foundation Contribution Details',
      ...
      cols:[['hgf','HGF'],['jfm','JFM'],['jfd','JFD'],['jfa','JFA'],
            ['jfp','JFP'],['jfs','JFS'],['jfg','JFG'],['rpp','RPP'],
            ['jfr','JFR'],['jfj','JFJ'],['jfk','JFK'],['sen','SEN'],
            ['ppp','PPP']] },
  ...
  training: { name:'Training', role:'National Director', sections:[
    ND_COMM, ND_POA, ND_PORTFOLIO_TARGETS, ND_ACTIONS,
    { type:'zone', key:'events', title:'Events Participation Details (Achieved / Target)',
      note:'Enter as achieved/target, e.g. 4/6.',
      cols:[['eps','EPS','text'],['capp','CAPP','text'],['jaf','JAF','text'],['ztws','ZTWS','text'],
            ['trainingDay','Training Day','text'],['nttts','NTTTS','text'],['nalanda','NALANDA','text'],
            ['outbound','Outbound Training','text']] },
  ...
  management: { name:'Management', role:'National Director', sections:[
    ...
    { type:'zone', key:'events', title:'Events Participation Details (Achieved / Target)',
      note:'Enter as achieved/target, e.g. 4/6.',
      cols:[['lots','LOTS','text'],['pa','PA','text'],['midcon','MIDCON','text'],['r2r','R2R','text'],
            ['aps','APS','text'],['star','STAR','text'],['parl','Mr. Parliamentarian','text'],
            ['zonecon','ZONECON','text']] },
  ]},
  pr: { name:'PR &amp; Marketing', role:'National Director', sections:[
    ND_COMM, ND_POA, ND_PORTFOLIO_TARGETS, ND_ACTIONS,
    ND_ZONE_PROGRAMS,
    ND_SPECIAL('JCI Branding, Clock Tower, Marathon, JCI Bhawan, etc.'),
    { type:'rows', key:'zdMeetings', title:'Zone Directors Meetings conducted during the period',
